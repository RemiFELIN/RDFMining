...
echo $(date +"%Y-%m-%d %H:%M:%S,%3N")" [fetch_db.sh] INFO - installing DAV ..."
mv /usr/local/virtuoso-opensource/share/virtuoso/vad/* /virtuoso/vads
# isql-v 1111 dba dba exec="vad_install('/virtuoso/vads/dbpedia_dav.vad', 0); vad_install('/virtuoso/vads/rdf_mappers_dav.vad', 0); vad_install('/virtuoso/vads/isparql_dav.vad', 0);"
isql-v 1111 dba dba exec="vad_install('/virtuoso/vads/isparql_dav.vad', 0);"
