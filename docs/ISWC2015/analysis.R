...
postscript("rank-ARI-20.eps")
rank <- order(d20$ncis)
plot(d20[rank,]$ari, rank, xlab = "Acceptance/Rejection Index", ylab = "Rank in Calculation Order", cex.lab = magnification, cex.axis = magnification)
abline(v = c(1/3), col="red")
dev.off()
system("rm time-ARI-20.pdf", ignore.stderr = TRUE, wait = FALSE)
