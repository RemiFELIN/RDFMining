...
public final class Constants {
     ...
     */
    public static final String TAIL_PERCENTAGE = "tail_percentage";
     ...
     */
    public static final String MAXPROBLEM_DEPTH = "maxproblem_depth";
     ...
     */
    public static final String PARITY_DEGREE = "parity_degree";

    /**
     * Specifying if an infix grammar
     */
    public static final String INFIX_GRAMMAR = "infix_grammar";
