...
/**
 * GEIndividual. Has a genotype, Phenotype and a GEGrammar. Has fields for
 * validity and mapped status. Only has one chromosome and grammar
 * 
 * @author Blip
 */
...
public class GEIndividual extends AbstractIndividual {
	 ...
	 */
	public static GEIndividual getIndividual(final GEGrammar grammar, final Phenotype phen, final Genotype genotype,
	...
	/**
	 * Sets the values reset by invalidate to the values from the individual passed
	 * in.
	 * 
	...
	/**
	 * Find out whether individual was *previously* valid. Used in
	 * NGramUpdateOperator, because it needs to know, after selection has
	 * invalidated everything, whether individuals are "really" valid.
	 * 
	...
	public void setTimeMapping(long timeMapping) {
	...
	/**
	 * Setting these both here so as to negate the need for multiple copies of the
	 * Mapper.
	 * 
	...
	/**
	 * Get number of codons used for mapping previoulsy. Used when the individual
	 * gets invalidated but previous information is needed
	 * 
