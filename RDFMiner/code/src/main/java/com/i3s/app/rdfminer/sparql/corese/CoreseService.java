...
public class CoreseService {
     ...
     */
    public static final String CORESE_SEND_SHACL_SHAPES_ENDPOINT = "rdfminer/upload";
     ...
     */
    public static final String PROBABILISTIC_SHACL_EVALUATION = "prob-shacl";

    /**
     * Corese params : SHACL Evaluation
     */
    public static final String SHACL_EVALUATION = "shacl";
