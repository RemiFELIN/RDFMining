...
if [ ! -f "$(pwd)/../$YML_FILE" ]; then 
    ...
    addLineToYML 11 "            source: "$WORKSPACE_ABSOLUTE_PATH"IO"
    addLineToYML 11 "            target: /rdfminer/io"
    addLineToYML 9 "          - type: bind"
    ...
    addLineToYML 11 "            target: /usr/local/corese/log"
    addLineToYML 9 "          - type: bind"
    addLineToYML 11 "            source: "$WORKSPACE_ABSOLUTE_PATH"Corese/data"
    addLineToYML 11 "            target: /usr/local/corese/data"
    addLineToYML 9 "          - type: bind"
