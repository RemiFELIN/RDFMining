...
import fr.inria.corese.gui.editor.button.*;
...
public class ShaclEditor extends JPanel {
    ...
    private void initButtonsPanel() {
        ...
        // Prob. Validate button
        ProbabilisticValidateShaclButton probabilisticValidateShaclButton = new ProbabilisticValidateShaclButton(this.editorPane, this.resultPane, this.mainFrame);
        buttonsPanel.add(probabilisticValidateShaclButton);
