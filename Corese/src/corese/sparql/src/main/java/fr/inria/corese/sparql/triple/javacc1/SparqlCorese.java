...
public class SparqlCorese implements SparqlCoreseConstants {
    ...
    final public Exp nquadPattern() throws ParseException {
        Exp stack;
        Atom subject, predicate, object, graph = null;
        stack = BasicGraphPattern.create();
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case ABASE:
            case BASE:
...
// *******************************************************************
            ...
            case DELETE:
                ...
                switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    case INSERT:
                        jj_consume_token(INSERT);
                        exp = QuadPattern();
                        ope = Composite.create(Update.INSERT);
                        ope.setPattern(exp);
                        upd.add(ope);
                        break;
                    default:
    ...
    final public Expression XML(Exp stack) throws ParseException {
        Expression box, exp, val, sep;
        ExpressionList list, attr;
        Token t;
        Constant uri = null, str;
    ...
    final public Expression PrimaryRegExp() throws ParseException {
        ...
        if (jj_2_16(2)) {
            ...
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                ...
                case LBRACKET:
                    stack = BasicGraphPattern.create();
                    subject = astq.createVariable(THIS);
                    jj_consume_token(LBRACKET);
            ...
            case AT:
                switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    case ATLIST:
                        ...
                        arobase = ASTQuery.L_LIST;
                        astq.setListType(arobase);
                        break;
                    case ATPATH:
                    case AT:
                        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
...
//        System.out.println("build multiplicative expression...");
        Token t1;
        Expression expression1, expression2;
...
//        System.out.println("build unary expression...");
        Token t1;
        Expression expression1;
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case BANG:
...
//        System.out.println("AAAAAAAAAAAAAH BuiltInCall");
            ...
            case IS_TRIPLE:
                switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    ...
                    case FLOOR:
                        ...
                        break;
                    case EXPONENTIAL:
                        t1 = jj_consume_token(EXPONENTIAL);
                        break;
                    case CEIL:
...
// by expanding out FunctionCall()
    ...
    final public Expression Body(Exp stack) throws ParseException {
        ExpressionList body = new ExpressionList();
        Expression exp = null;
        jj_consume_token(LBRACE);
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case RBRACE:
  ...
  public void ReInit(SparqlCoreseTokenManager tm) {
    ...
    final private Token jj_consume_token(int kind) throws ParseException {
        System.out.println("jj_consume_token: " + kind);
        Token oldToken;
