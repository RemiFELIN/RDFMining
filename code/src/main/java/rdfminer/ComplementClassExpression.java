...
public class ComplementClassExpression extends ComplementExpression
{
	...
	/**
	 * Creates a new complement class expression based on the provided functional-style syntax.
	...
	/**
	 * Creates a new complement class expression from the class expression of its complement.
	 * 
