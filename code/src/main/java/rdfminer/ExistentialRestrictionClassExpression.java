...
/**
 * An existential restriction class expression of the form ObjectSomeValuesFrom(...) or ObjectHasValue(...).
 * 
...
public class ExistentialRestrictionClassExpression extends Expression
{
	...
	/**
	 * Creates a new existential restriction class expression based on the
	...
	/**
	 * Instantiates the graph pattern for this existential restriction class expression.
	 * 
