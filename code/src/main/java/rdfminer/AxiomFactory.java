...
/**
 * The axiom factory singleton class is able to construct axioms of various types. 
...
public class AxiomFactory extends DLFactory
{
	 ...
	 * <p>The types of axioms that are provided for by OWL 2 are the following 32,
	 * divided in six categories:</p>
	 * <ul>
	 ...
	 * model-theoretic semantics of all the types of axioms, compatible with
