 ...
 * <p>This class just contains some utility methods that are used to parse lists of symbols.</p> 
 */
public class DLFactory
{
	/**
	 * Parse a term in a list of symbols starting at the given position and put it in the given list.
	 * <p>Consecutive symbols different from "(", " ", and ")" are concatenated into a single symbol.</p>
	 * 
