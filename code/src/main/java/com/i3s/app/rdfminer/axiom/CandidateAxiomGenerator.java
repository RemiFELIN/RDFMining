...
/**
 * An exhaustive generator of SubClassOf axioms with atomic left- and right-hand side, written for the ISWC 2014 paper.
 * <p>For all classes in the "Class" production, retrieve their instances, and consider as a candidate superclass
 ...
 * "<tt>AxiomGenerator.status</tt>", so that it will be able to resume from where it left in case of crash.
...
{
	private static Logger logger = Logger.getLogger(CandidateAxiomGenerator.class.getName());
