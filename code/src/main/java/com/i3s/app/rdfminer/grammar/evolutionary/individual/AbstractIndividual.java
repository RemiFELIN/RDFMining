...
/**
 * An Abstract individual. An abstract individual class implements a couple of
 * the get/set patterns and adds a fitness data member.
 * 
 * @author Blip
 */
...
public abstract class AbstractIndividual implements Individual {
	...
	static {
		AbstractIndividual.uidCounter = 0;
	}
