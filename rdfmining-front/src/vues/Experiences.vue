<template>
    ...
    <form>
        ...
        <div v-if="mod.includes('-ge')">
            ...
            <!-- Max wrapping -->
            <CTextNumber :description="'Max Wrap'" :defaultValue="maxWrap" :min="1"
                @textNumberChanged="updateMaxWrap"></CTextNumber>
            <!-- Selection: type of selection and proportion -->
            <CSelect :description="'Selection Type'" :defaultValue="choosenSelection" :values="typeSelection" @selectValueChanged="updateTypeSelection"></CSelect>
            <CSlider :description="'Selected Individuals Proportion'" :defaultValue="selectionRate" @pValue="updateSelectionRate"></CSlider>
            <!-- Crossover: type of crossover and probability -->
            <CSelect :description="'Crossover Type'" :defaultValue="choosenCrossover" :values="typeCrossover" @selectValueChanged="updateTypeCrossover"></CSelect>
            ...
            <CSelect :description="'Mutation Type'" :defaultValue="choosenMutation" :values="typeMutation" @selectValueChanged="updateTypeMutation"></CSelect>
            <CSlider :description="'P(Mutation)'" :defaultValue="pMutValue" @pValue="updatePMutValue"></CSlider>
            <!-- Enable Crowding method -->
            <CCheckbox :description="'Enable Crowding Method ?'" :defaultValue="false" @checkboxChanged="updateEnableCrowding"></CCheckbox>
            <!-- Enable Novelty Search -->
            <CCheckbox :description="'Enable Novelty Search ?'" :defaultValue="false" @checkboxChanged="updateEnableNoveltySearch"></CCheckbox>
