...
import com.i3s.app.rdfminer.evolutionary.geva.Util.Statistics.IndividualCatcher;
...
public interface OutputI {
     ...
     */
    void print(List<Individual> operand, boolean toFile);

    IndividualCatcher getBest(List<Individual> operand);
